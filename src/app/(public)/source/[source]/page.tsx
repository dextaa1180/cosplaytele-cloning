...
import { filterPostsBySource, getSourceName } from '@/lib/sources';
...
export default async function SourcePage({ params }: SourcePageProps) {
  ...
  const filteredPosts = filterPostsBySource(posts, source);
  const sourceName = getSourceName(posts, source);
